...
public class RenderPanel extends JPanel {
	...
	protected void paintComponent(Graphics g) {
		...
		for (StaticEdge edge : cannon.edges) {
...
//		g2.setColor(Color.cyan); // Use green for edges
//		for (int i = 0; i < cannon.joints1.size(); i++) {
//			Body b1 = cannon.joints1.get(i);
//			Body b2 = cannon.joints2.get(i);
//
//			// compute end‐points in screen space
...
//
//			// world‐space half‐thickness → full thickness in pixels
//			float pixelThickness = 0.2f * scale;
//
//			// set stroke to that thickness
//			Stroke stroke = new BasicStroke(pixelThickness, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND);
//			g2.setStroke(stroke);
